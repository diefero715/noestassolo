...
<body>
            ...
            <div class="navbar-nav">
                <div class="nav-item dropdown">
                    <a class="nav-item dropdown nav-link dropdown-toggle" href="#" id="navbarDropdownMenuUser"
                        ...
                        <img src="static/images/logo_seguidor.png" height="30" class="rounded-circle d-inline-block mr-1">
                        <span>Diefer715</span>
                    </a>
    ...
    <div class="profile d-flex flex-column align-items-center justify-content-center">
        ...
        <div>
            <img src="static/images/logo_seguidor.png" height="150" alt="image" class="rounded-circle">
        </div>
