    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse d-sm-flex justify-content-between" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="biblioteca.php" title="Boton Mi Biblioteca">Mi Biblioteca</a>
                <div class="nav-item dropdown">
                    <a class="nav-item dropdown nav-link dropdown-toggle" href="#" title="Boton Planes" id="navbarDropdownMenuCategories"
                            ...
                            <div class="col">
                                <div class="card border-0 text-left" style="max-width: 100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                            <a target="_blank" href="static/images/agendafloral.jpg"><img src="static/images/agendafloral.jpg" title="Agenda Floral" class="card-img"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card border-0 text-left" style="max-width: 100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                            <a target="_blank" href="static/images/agendacolor.jpg"><img src="static/images/agendacolor.jpg" title="Agenda Colors" class="card-img"
                            ...
                            <div class="col">
                                <div class="card border-0 text-left" style="max-width: 100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                            <a target="_blank" href="static/images/agenda2.jpg"><img src="static/images/agenda2.jpg" title="Agenda Vintash" class="card-img"
                                                    width="100%" height="100%" alt="..."></a>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body" style="font-size: 0.9rem;">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card border-0 text-left" style="max-width: 100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                            <a target="_blank" href="static/images/agendaharry.jpg"><img src="static/images/agendaharry.jpg" title="Agenda Harry Potter" class="card-img"
                                                    width="150%" height="150%" alt="..."></a>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body" style="font-size: 0.9rem;">
                            ...
                            <div class="col">
                                <div class="card border-0 text-left" style="max-width: 100%;">
                                    <div class="row no-gutters">
                                        <div class="col-md-4">
                                            <a target="_blank" href="static/images/agendaescolar.jpg"><img src="static/images/agendaescolar.jpg" title="Agenda Escolar" class="card-img"
                                                    width="100%" height="100%" alt="..."></a>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body" style="font-size: 0.9rem;">
